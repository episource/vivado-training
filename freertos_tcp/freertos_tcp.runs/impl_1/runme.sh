...
HD_PWD='C:/Users/Philipp/Documents/Scratch/Vivado/vivado-training/freertos_tcp/freertos_tcp.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log zeth_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source zeth_wrapper.tcl -notrace
