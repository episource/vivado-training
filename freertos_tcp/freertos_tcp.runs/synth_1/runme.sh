...
HD_PWD='C:/Users/Philipp/Documents/Scratch/Vivado/vivado-training/freertos_tcp/freertos_tcp.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zeth_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zeth_wrapper.tcl
