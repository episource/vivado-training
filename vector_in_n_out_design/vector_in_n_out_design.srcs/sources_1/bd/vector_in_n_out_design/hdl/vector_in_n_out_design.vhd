...
--Date        : Sat Sep  9 21:19:45 2017
--Host        : Wimucs running 64-bit major release  (build 9200)
--Command     : generate_target vector_in_n_out_design.bd
--Design      : vector_in_n_out_design
...
entity vector_in_n_out_design is
  port (
    ...
    led_in : out STD_LOGIC_VECTOR ( 1 downto 0 );
    led_out : out STD_LOGIC_VECTOR ( 1 downto 0 )
  );
  attribute CORE_GENERATION_INFO : string;
  attribute CORE_GENERATION_INFO of vector_in_n_out_design : entity is "vector_in_n_out_design,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=vector_in_n_out_design,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=2,numReposBlks=2,numNonXlnxBlks=1,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_ps7_cnt=1,synth_mode=OOC_per_IP}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of vector_in_n_out_design : entity is "vector_in_n_out_design.hwdef";
end vector_in_n_out_design;

architecture STRUCTURE of vector_in_n_out_design is
  component vector_in_n_out_design_processing_system7_0_0 is
  port (
  ...
  end component vector_in_n_out_design_processing_system7_0_0;
  component vector_in_n_out_design_vector_in_n_out_0_0 is
  port (
    inv : in STD_LOGIC_VECTOR ( 1 downto 0 );
    outv : out STD_LOGIC_VECTOR ( 1 downto 0 )
  );
  end component vector_in_n_out_design_vector_in_n_out_0_0;
...
begin
  led_in(1 downto 0) <= processing_system7_0_GPIO_O(1 downto 0);
  led_out(1 downto 0) <= vector_in_n_out_0_outv(1 downto 0);
processing_system7_0: component vector_in_n_out_design_processing_system7_0_0
     port map (
...
vector_in_n_out_0: component vector_in_n_out_design_vector_in_n_out_0_0
     port map (
