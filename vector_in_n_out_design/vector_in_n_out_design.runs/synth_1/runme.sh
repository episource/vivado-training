...
HD_PWD='C:/Users/Philipp/Documents/Scratch/Vivado/vivado-training/vector_in_n_out_design/vector_in_n_out_design.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vector_in_n_out_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vector_in_n_out_design_wrapper.tcl
