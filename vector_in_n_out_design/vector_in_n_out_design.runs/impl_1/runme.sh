...
HD_PWD='C:/Users/Philipp/Documents/Scratch/Vivado/vivado-training/vector_in_n_out_design/vector_in_n_out_design.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vector_in_n_out_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vector_in_n_out_design_wrapper.tcl -notrace
