...
entity gpio_adapter_design is
  ...
  attribute CORE_GENERATION_INFO of gpio_adapter_design : entity is "gpio_adapter_design,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=gpio_adapter_design,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=6,numReposBlks=6,numNonXlnxBlks=2,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=1,da_board_cnt=5,da_ps7_cnt=1,synth_mode=OOC_per_IP}";
...
architecture STRUCTURE of gpio_adapter_design is
  ...
  component gpio_adapter_design_xlslice_0_0 is
  port (
    Din : in STD_LOGIC_VECTOR ( 3 downto 0 );
    Dout : out STD_LOGIC_VECTOR ( 1 downto 0 )
  );
  end component gpio_adapter_design_xlslice_0_0;
  component gpio_adapter_design_xlslice_1_0 is
  port (
    Din : in STD_LOGIC_VECTOR ( 3 downto 0 );
    Dout : out STD_LOGIC_VECTOR ( 1 downto 0 )
  );
  end component gpio_adapter_design_xlslice_1_0;
...
vector_in_n_out_0: component gpio_adapter_design_vector_in_n_out_0_0
     port map (
      inv(1 downto 0) => xlslice_0_Dout(1 downto 0),
...
xlslice_0: component gpio_adapter_design_xlslice_0_0
     port map (
      Din(3 downto 0) => processing_system7_0_GPIO_O(3 downto 0),
      Dout(1 downto 0) => xlslice_0_Dout(1 downto 0)
    );
xlslice_1: component gpio_adapter_design_xlslice_1_0
     port map (
      Din(3 downto 0) => processing_system7_0_GPIO_O(3 downto 0),
