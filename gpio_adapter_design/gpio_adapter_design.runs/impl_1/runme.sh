...
HD_PWD='C:/Users/Philipp/Documents/Scratch/Vivado/vivado-training/gpio_adapter_design/gpio_adapter_design.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log gpio_adapter_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source gpio_adapter_design_wrapper.tcl -notrace
