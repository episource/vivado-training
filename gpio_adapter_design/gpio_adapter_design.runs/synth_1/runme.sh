...
HD_PWD='C:/Users/Philipp/Documents/Scratch/Vivado/vivado-training/gpio_adapter_design/gpio_adapter_design.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gpio_adapter_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gpio_adapter_design_wrapper.tcl
