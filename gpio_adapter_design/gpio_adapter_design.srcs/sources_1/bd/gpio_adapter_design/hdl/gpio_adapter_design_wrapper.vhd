...
--Command     : generate_target gpio_adapter_design_wrapper.bd
--Design      : gpio_adapter_design_wrapper
...
entity gpio_adapter_design_wrapper is
  port (
...
end gpio_adapter_design_wrapper;

architecture STRUCTURE of gpio_adapter_design_wrapper is
  component gpio_adapter_design is
  port (
    DDR_cas_n : inout STD_LOGIC;
    DDR_cke : inout STD_LOGIC;
    DDR_ck_n : inout STD_LOGIC;
  ...
  end component gpio_adapter_design;
  component IOBUF is
  port (
    I : in STD_LOGIC;
    O : out STD_LOGIC;
...
begin
gpio_adapter_design_i: component gpio_adapter_design
     port map (
